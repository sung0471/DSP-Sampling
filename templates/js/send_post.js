function send_data() {
    ...
    for (var i = 0; i <= count; i++) {
        attr[0] = parseFloat(document.getElementById("frequency[" + String(i) + "]").value);
        attr[1] = parseFloat(document.getElementById("amplitude[" + String(i) + "]").value);
        attr[2] = parseFloat(document.getElementById("phase[" + String(i) + "]").value);
